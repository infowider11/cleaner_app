...
class Map_DropDown extends StatefulWidget {
  final String label;
  ...
  @override
  State<Map_DropDown> createState() => _Map_DropDownState();
}

class _Map_DropDownState extends State<Map_DropDown> {
  // final List<String> items = [
  //   'All',
  //   'Option 1',
  //   'Option 2',
